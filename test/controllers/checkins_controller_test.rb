...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post checkins_url, params: { checkin: { checkout: @checkin.checkout, destination_id: @checkin.destination_id, skier_id: @checkin.skier_id } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { checkout: @checkin.checkout, destination_id: @checkin.destination_id, skier_id: @checkin.skier_id } }
